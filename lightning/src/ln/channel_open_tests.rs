...
use crate::ln::channel::{
	...
	OutboundV1Channel, COINBASE_MATURITY, MIN_AFFORDABLE_HTLC_COUNT,
...
use crate::ln::{chan_utils, functional_test_utils::*, msgs};
...
fn test_inbound_anchors_manual_acceptance() {
	let mut anchors_cfg = test_anchors_channel_config();
...
fn test_inbound_anchors_config_overridden() {
	...
	let anchors_cfg = test_anchors_channel_config();
...
fn test_zero_fee_commitments_downgrade_to_static_remote() {
	...
	let mut receiver_cfg = test_default_channel_config();
	receiver_cfg.channel_handshake_config.negotiate_anchor_zero_fee_commitments = true;
	receiver_cfg.channel_handshake_config.negotiate_anchors_zero_fee_htlc_tx = false;
...
pub fn test_insane_channel_opens() {
	...
	let commit_tx_fee = chan_utils::commit_tx_fee_sat(
		253,
		MIN_AFFORDABLE_HTLC_COUNT,
		&ChannelTypeFeatures::anchors_zero_htlc_fee_and_dependencies(),
	);
	let push_msat = (channel_value_sat - channel_reserve_satoshis - commit_tx_fee) * 1000;
