...
pub struct CommitmentTransaction {
	...
	pub to_broadcaster_value_sat: Amount,
	pub to_countersignatory_value_sat: Amount,
	pub to_broadcaster_delay: Option<u16>, // Added in 0.0.117
	pub feerate_per_kw: u32,
	// The set of non-dust HTLCs included in the commitment. They must be sorted in increasing
	// output index order.
	pub nondust_htlcs: Vec<HTLCOutputInCommitment>,
