...
pub struct CommitmentData<'a> {
	pub tx: CommitmentTransaction,
	pub stats: CommitmentStats,
	pub htlcs_included: Vec<(HTLCOutputInCommitment, Option<&'a HTLCSource>)>, // the list of HTLCs (dust HTLCs *included*) which were not ignored when building the transaction
...
pub struct CommitmentStats {
	pub feerate_per_kw: u32, // the feerate of the commitment transaction
	pub total_fee_sat: u64, // the total fee included in the transaction
	pub total_anchors_sat: u64, // the sum of the anchors' amounts
	pub broadcaster_dust_limit_sat: u64, // the broadcaster's dust limit
	pub local_balance_before_fee_anchors_msat: u64, // local balance before fees and anchors *not* considering dust limits
	pub remote_balance_before_fee_anchors_msat: u64, // remote balance before fees and anchors *not* considering dust limits
}
...
pub enum HolderCommitmentPoint {
...
pub struct FundingScope {
	pub value_to_self_msat: u64, // Excluding all pending_htlcs, fees, and anchor outputs
...
impl<SP: Deref> ChannelContext<SP> where SP::Target: SignerProvider {
	...
	#[inline]
	pub fn build_commitment_transaction<L: Deref>(&self, funding: &FundingScope, commitment_number: u64, per_commitment_point: &PublicKey, local: bool, generated_by_local: bool, logger: &L) -> CommitmentData
		where L::Target: Logger
	{
...
pub struct FundedChannel<SP: Deref> where SP::Target: SignerProvider {
	pub funding: FundingScope,
	pending_funding: Vec<FundingScope>,
	pub context: ChannelContext<SP>,
	pub interactive_tx_signing_session: Option<InteractiveTxSigningSession>,
	pub holder_commitment_point: HolderCommitmentPoint,
