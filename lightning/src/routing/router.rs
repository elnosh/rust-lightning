...
mod tests {
	...
	fn htlc_minimum_test() {
		...
		// Disable other paths
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 12, timestamp: 2, channel_flags: 2,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 3, timestamp: 2, channel_flags: 2,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[7], make_chan_update(ChanUpdate {
			scid: 13, timestamp: 2, channel_flags: 2,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[2], make_chan_update(ChanUpdate {
			scid: 6, timestamp: 2, channel_flags: 2,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[2], make_chan_update(ChanUpdate {
			scid: 7, timestamp: 2, channel_flags: 2,
			..Default::default()
		}));
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 2, timestamp: 3, htlc_minimum_msat: 200_000_000,
			..Default::default()
		}));

		// Second hop only allows to forward 199_999_999 at most, thus not allowing the first hop to
		// be used.
		update_channel(&gossip_sync, &secp_ctx, &privkeys[1], make_chan_update(ChanUpdate {
			scid: 4, timestamp: 3, htlc_maximum_msat: 199_999_999,
			..Default::default()
		}));
	...
	fn htlc_minimum_overpay_test() {
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 2, timestamp: 2, htlc_minimum_msat: 35_000, htlc_maximum_msat: 40_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 12, timestamp: 3, htlc_minimum_msat: 35_000, htlc_maximum_msat: 40_000,
			..Default::default()
		}));
		...
		// Disable other paths
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 1, timestamp: 3, channel_flags: 2,
			..Default::default()
		}));
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 12, timestamp: 4, htlc_minimum_msat: 65_000, htlc_maximum_msat: 80_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 2, timestamp: 3,
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[1], make_chan_update(ChanUpdate {
			scid: 4, timestamp: 4, fee_proportional_millionths: 100_000,
			..Default::default()
		}));
	...
	fn htlc_minimum_recipient_overpay_test() {
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[2], make_chan_update(ChanUpdate {
			scid: 13, timestamp: 2, channel_flags: 3, htlc_maximum_msat: 0,
			..Default::default()
		}));

		// Set channel 4 to free but with a high htlc_minimum_msat
		update_channel(&gossip_sync, &secp_ctx, &privkeys[1], make_chan_update(ChanUpdate {
			scid: 4, timestamp: 2, htlc_minimum_msat: 15_000,
			..Default::default()
		}));
	...
	fn disable_channels_test() {
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[1], make_chan_update(ChanUpdate {
			scid: 4, timestamp: 2, channel_flags: 2,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 12, timestamp: 2, channel_flags: 2,
	...
	fn available_amount_while_routing_test() {
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 2, timestamp: 2, channel_flags: 2, htlc_maximum_msat: 100_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 12, timestamp: 2, channel_flags: 2, htlc_maximum_msat: 100_000,
			..Default::default()
		}));
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 1, timestamp: 2, htlc_maximum_msat: 1_000_000_000,
			..Default::default()
		}));
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 3, timestamp: 2, htlc_maximum_msat: 250_000_000,
			..Default::default()
		}));
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 1, timestamp: 3, channel_flags: 2, htlc_maximum_msat: 1_000_000_000,
			..Default::default()
		}));
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 1, timestamp: 4, htlc_maximum_msat: 1_000_000_000,
			..Default::default()
		}));
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 3, timestamp: 3, htlc_maximum_msat: 15_000,
			..Default::default()
		}));
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 3, timestamp: 4, channel_flags: 2,
			..Default::default()
		}));
		...
		*chain_monitor.utxo_ret.lock().unwrap() =
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 333, timestamp: 1, cltv_expiry_delta: (3 << 4) | 1, htlc_maximum_msat: 15_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[2], make_chan_update(ChanUpdate {
			scid: 333, timestamp: 1, channel_flags: 1, cltv_expiry_delta: (3 << 4) | 2,
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 333, timestamp: 6, htlc_maximum_msat: 10_000,
			..Default::default()
		}));
	...
	fn available_liquidity_last_hop_test() {
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[2], make_chan_update(ChanUpdate {
			scid: 7, timestamp: 2, channel_flags: 2, htlc_maximum_msat: 100_000,
			..Default::default()
		}));
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 12, timestamp: 2, htlc_maximum_msat: 100_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[7], make_chan_update(ChanUpdate {
			scid: 13, timestamp: 2, htlc_maximum_msat: 100_000,
			..Default::default()
		}));

		update_channel(&gossip_sync, &secp_ctx, &privkeys[2], make_chan_update(ChanUpdate {
			scid: 6, timestamp: 2, htlc_maximum_msat: 50_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[4], make_chan_update(ChanUpdate {
			scid: 11, timestamp: 2, htlc_maximum_msat: 100_000,
			..Default::default()
		}));
		{
			// Attempt to route more than available results in a failure.
	...
	fn ignore_fee_first_hop_test() {
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 1, timestamp: 2, htlc_maximum_msat: 100_000, fee_base_msat: 1_000_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 3, timestamp: 2, htlc_maximum_msat: 50_000,
			..Default::default()
		}));
	...
	fn do_simple_mpp_route_test(payment_params: PaymentParameters) {
		...
		// Path via node0 is channels {1, 3}. Limit them to 100 and 50 sats (total limit 50).
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 1, timestamp: 2, htlc_maximum_msat: 100_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 3, timestamp: 2, htlc_maximum_msat: 50_000,
		...
		// (total limit 60).
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 12, timestamp: 2, htlc_maximum_msat: 60_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[7], make_chan_update(ChanUpdate {
			scid: 13, timestamp: 2, htlc_maximum_msat: 60_000,
			..Default::default()
		}));
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 2, timestamp: 2, htlc_maximum_msat: 200_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[1], make_chan_update(ChanUpdate {
			scid: 4, timestamp: 2, htlc_maximum_msat: 180_000,
			..Default::default()
		}));
	...
	fn do_mpp_route_tests(amt: u64) -> Result<Route, &'static str> {
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[1], make_chan_update(ChanUpdate {
			scid: 4, timestamp: 2, channel_flags: 2, htlc_maximum_msat: 100_000,
			..Default::default()
		}));
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 3, timestamp: 2, htlc_maximum_msat: 100_000,
			..Default::default()
		}));

		add_channel(&gossip_sync, &secp_ctx, &privkeys[1], &privkeys[3], ChannelFeatures::from_le_bytes(id_to_feature_flags(16)), 16);
		update_channel(&gossip_sync, &secp_ctx, &privkeys[1], make_chan_update(ChanUpdate {
			scid: 16, timestamp: 2, htlc_maximum_msat: 100_000, fee_base_msat: 1_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[3], make_chan_update(ChanUpdate {
			scid: 16, timestamp: 2, channel_flags: 3, htlc_maximum_msat: 100_000, fee_base_msat: 1_000,
			..Default::default()
		}));
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[2], make_chan_update(ChanUpdate {
			scid: 6, timestamp: 2, htlc_maximum_msat: 200_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[4], make_chan_update(ChanUpdate {
			scid: 11, timestamp: 2, htlc_maximum_msat: 200_000,
			..Default::default()
		}));
	...
	fn fees_on_mpp_route_test() {
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[2], make_chan_update(ChanUpdate {
			scid: 5, timestamp: 2, htlc_maximum_msat: 100_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[3], make_chan_update(ChanUpdate {
			scid: 5, timestamp: 2, channel_flags: 3, htlc_maximum_msat: 100_000,
			..Default::default()
		}));
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 12, timestamp: 2, htlc_maximum_msat: 250_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[7], make_chan_update(ChanUpdate {
			scid: 13, timestamp: 2,
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[2], make_chan_update(ChanUpdate {
			scid: 6, timestamp: 2, fee_base_msat: 150_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[4], make_chan_update(ChanUpdate {
			scid: 11, timestamp: 2,
	...
	fn mpp_with_last_hops() {
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 1, timestamp: 2, cltv_expiry_delta: (5 << 4) | 5, htlc_maximum_msat: 99_000,
			fee_base_msat: u32::max_value(), fee_proportional_millionths: u32::max_value(),
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 2, timestamp: 2, cltv_expiry_delta: (5 << 4) | 3, htlc_maximum_msat: 99_000,
			fee_base_msat: u32::max_value(), fee_proportional_millionths: u32::max_value(),
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[1], make_chan_update(ChanUpdate {
			scid: 4, timestamp: 2, cltv_expiry_delta: (4 << 4) | 1, fee_base_msat: 1,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[7], make_chan_update(ChanUpdate {
			scid: 13, timestamp: 2, channel_flags: 0|2, cltv_expiry_delta: (13 << 4) | 1,
	...
	fn drop_lowest_channel_mpp_route_test() {
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 3, timestamp: 2, htlc_maximum_msat: 50_000, fee_base_msat: 100,
			..Default::default()
		}));

		// Path via node7 is channels {12, 13}. Limit them to 60 and 60 sats (total limit 60);
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 12, timestamp: 2, htlc_maximum_msat: 60_000, fee_base_msat: 100,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[7], make_chan_update(ChanUpdate {
			scid: 13, timestamp: 2, htlc_maximum_msat: 60_000,
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 2, timestamp: 2, htlc_maximum_msat: 20_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[1], make_chan_update(ChanUpdate {
			scid: 4, timestamp: 2, htlc_maximum_msat: 20_000,
			..Default::default()
		}));
	...
	fn min_criteria_consistency() {
		...
		for (key, channel_flags) in [(&our_privkey, 0), (&privkeys[1], 3)] {
			update_channel(&gossip_sync, &secp_ctx, key, make_chan_update(ChanUpdate {
				scid: 6, timestamp: 1, channel_flags, cltv_expiry_delta: (6 << 4) | 0,
				..Default::default()
			}));
		}
		...
		for (key, channel_flags) in [(&privkeys[1], 0), (&privkeys[4], 3)] {
			update_channel(&gossip_sync, &secp_ctx, key, make_chan_update(ChanUpdate {
				scid: 5, timestamp: 1, channel_flags, cltv_expiry_delta: (5 << 4) | 0, fee_base_msat: 100,
				..Default::default()
			}));
		}
		...
		for (key, channel_flags) in [(&privkeys[4], 0), (&privkeys[3], 3)] {
			update_channel(&gossip_sync, &secp_ctx, key, make_chan_update(ChanUpdate {
				scid: 4, timestamp: 1, channel_flags, cltv_expiry_delta: (4 << 4) | 0,
				..Default::default()
			}));
		}
		...
		for (key, channel_flags) in [(&privkeys[3], 0), (&privkeys[2], 3)] {
			update_channel(&gossip_sync, &secp_ctx, key, make_chan_update(ChanUpdate {
				scid: 3, timestamp: 1, channel_flags, cltv_expiry_delta: (3 << 4) | 0,
				..Default::default()
			}));
		}
		...
		for (key, channel_flags) in [(&privkeys[2], 0), (&privkeys[4], 3)] {
			update_channel(&gossip_sync, &secp_ctx, key, make_chan_update(ChanUpdate {
				scid: 2, timestamp: 1, channel_flags, cltv_expiry_delta: (2 << 4) | 0,
				..Default::default()
			}));
		}
		...
		for (key, channel_flags) in [(&privkeys[4], 0), (&privkeys[6], 3)] {
			update_channel(&gossip_sync, &secp_ctx, key, make_chan_update(ChanUpdate {
				scid: 1, timestamp: 1, channel_flags, cltv_expiry_delta: (1 << 4) | 0, htlc_minimum_msat: 100,
				..Default::default()
			}));
		}
	...
	fn exact_fee_liquidity_limit() {
		...
		// send.
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 2, timestamp: 2, htlc_maximum_msat: 85_000,
			..Default::default()
		}));

		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 12, timestamp: 2, cltv_expiry_delta: (4 << 4) | 1, htlc_maximum_msat: 270_000,
	...
	fn htlc_max_reduction_below_min() {
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 2, timestamp: 2, htlc_maximum_msat: 80_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[1], make_chan_update(ChanUpdate {
			scid: 4, timestamp: 2, cltv_expiry_delta: (4 << 4) | 1, htlc_minimum_msat: 90_000,
			..Default::default()
		}));
	...
	fn avoids_saturating_channels() {
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[1], make_chan_update(ChanUpdate {
			scid: 4, timestamp: 2, cltv_expiry_delta: (4 << 4) | 1, htlc_maximum_msat: 250_000_000,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[7], make_chan_update(ChanUpdate {
			scid: 13, timestamp: 2, cltv_expiry_delta: (13 << 4) | 1, htlc_maximum_msat: 250_000_000,
			..Default::default()
		}));
	...
	fn direct_to_intro_node() {
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 1, timestamp: 1, cltv_expiry_delta: 42,
			htlc_minimum_msat: 1_000, htlc_maximum_msat: 10_000_000, fee_base_msat: 800,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[1], make_chan_update(ChanUpdate {
			scid: 1, timestamp: 1, channel_flags: 1, cltv_expiry_delta: 42,
			htlc_minimum_msat: 1_000, htlc_maximum_msat: 10_000_000, fee_base_msat: 800,
			..Default::default()
		}));
		let first_hops = [
	...
	fn candidate_path_min() {
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 6, timestamp: 1, cltv_expiry_delta: (6 << 4) | 0,
			..Default::default()
		}));
	...
	fn first_hop_preferred_over_hint() {
		...
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 2, timestamp: 2, cltv_expiry_delta: 42,
			htlc_minimum_msat: 1_000, htlc_maximum_msat: 10_000_000, fee_base_msat: 800,
			..Default::default()
		}));
		update_channel(&gossip_sync, &secp_ctx, &privkeys[1], make_chan_update(ChanUpdate {
			scid: 2, timestamp: 2, channel_flags: 1, cltv_expiry_delta: 42,
			htlc_minimum_msat: 1_000, htlc_maximum_msat: 10_000_000, fee_base_msat: 800,
			..Default::default()
		}));
	...
	fn test_max_final_contribution() {
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 1, timestamp: 2, cltv_expiry_delta: (1 << 4) | 1, htlc_maximum_msat: 1_000_000,
			..Default::default()
		}));

		// Set the fee on channel 3 to zero
		update_channel(&gossip_sync, &secp_ctx, &privkeys[0], make_chan_update(ChanUpdate {
			scid: 3, timestamp: 2, cltv_expiry_delta: (3 << 4) | 1, htlc_maximum_msat: 1_000_000_000,
			..Default::default()
		}));

		// Set the fee on channel 6 to 1 millionth
		update_channel(&gossip_sync, &secp_ctx, &privkeys[2], make_chan_update(ChanUpdate {
			scid: 6, timestamp: 2, cltv_expiry_delta: (6 << 4) | 1, htlc_maximum_msat: 1_000_000_000,
		...
		update_channel(&gossip_sync, &secp_ctx, &our_privkey, make_chan_update(ChanUpdate {
			scid: 1, timestamp: 3, cltv_expiry_delta: (1 << 4) | 1, htlc_maximum_msat: 1_000_001,
			..Default::default()
		}));
